...
var import_shared_types = require("@bocardo/shared-types");
var import_jsx_runtime = require("react/jsx-runtime");
var CurrencyDisplay = ({
  paise,
  className = "font-semibold text-slate-900"
}) => {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className, children: (0, import_shared_types.formatPaiseToRupees)(paise) });
};
...
var VegNonVegBadge = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
    "div",
    {
      ...
      children: isVeg ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: `rounded-full bg-green-600 ${dotSize}` }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
        "span",
        {
